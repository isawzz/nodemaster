require([
	...
	sampleInstructions.innerHTML = ['<b>Drag</b> the pointer over the data to view stats', 'within one mile of the pointer location.'].join(' ');
	...
	function createCharts() {
		...
		raceChart = new Chart(raceCanvas.getContext('2d'), {
			...
			data: {
				...
				datasets: [
					{
						backgroundColor: ['#ed5050', '#7c2525', '#149dcf', '#0a4d66', '#a6c736', '#52631a', '#fc9220', '#7c470d'],
						borderColor: 'rgb(255, 255, 255)',
						borderWidth: 1,
